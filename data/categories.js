const categories = {
  eating: `afgan, 
        ...
        yugoslav,
        `,
  studying: 'beaches, bagels, bubbletea, coffee, coffeeroasteries, juicebars, libraries, collegeuniv, tutoring, tea, icecream, desserts',
  dating:
    'amusementparks, beaches, bagels, bakeries, bubbletea, icecream, desserts, shavedice, coffee, clubcrawl, countrydancehalls, danceclubs, dancerestaurants,jazzandblues, karaoke, musicvenues, pianobars, artmuseums, musicvenues, paintandsip, juicebars, tea, tours, aerialtours, architecturaltours, arttours, beertours, biketours, boattours, bustours, foodtours, historicaltours, scootertours, walkingtours, whalewatchingtours, publicart, gastropubs, milkbars, hiking, parks, gelato, donuts, localflavor',
  relaxing:
    'amusementparks, beaches, meditationcenters, yoga, jazzandblues, mahjong, observatories, opera, pachinko, paintandsip, theater, planetarium, sportsbetting, studiotaping, psychic_astrology, beautysvc, spas, eroticmassage, footcare hotsprings, massage, tanning, cannabis_clinics, cannabisreferrals, publicart, adultentertainment, stripclubs, stripteasedancers, hiking, parks, gelato, bagels, localflavor',
  drinking:
    'beer, wine, beer_and_wine, spirits, breweries, brewpubs, beerbar bubbletea, cideries, coffee, coffeeroasteries, juicebars, kombucha, meaderies, milkshakebars, gluhwein, tea, wineries, bars, absinthebars, airportlounges, beachbars, champagene_bars, cigarbars, cocktailbars, divebars, drivethrubars, gaybars, hookah_bars, hotel_bar, irish_pubs, lounges, pubs, pulquerias, sakebars, speakeasies, sportsbars, tabac, tikibars, vermouthbars, wine_bars, beergardens, paintandsip, gastropubs',
